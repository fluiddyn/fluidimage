...
def sharpen(img=None, sigma1=3., sigma2=1., alpha=30.):
    ...
    filter_blurred = nd.gaussian_filter(blurred_f, sigma2)
...
class PreprocTools(object):
    ...
    def _complete_class_with_tools(cls, params):
        """
        Dynamically add the global functions in this module as classmethods of the class.
        Also create default parameters from the functions argument list.
        """
    ...
    def apply_all(self, img):
        ...
        for tool in self.params.available_tools:
