# -*- coding: utf-8 -*-
#
# fluidimage documentation build configuration file, copied from a file created by
...
release = fluidimage.__version__
...
html_short_title = "FluidImage " + release
...
man_pages = [
    ("index", "FluidImage", "FluidImage Documentation", ["Pierre Augier"], 1)
]
